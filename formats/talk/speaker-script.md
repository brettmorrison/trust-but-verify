...
- **Handouts in your hand, not on a table.** You'll give them out personally at
  the end.
- **Check the back row can read slide 4** from where they're sitting. If not,
  move people forward rather than apologising for the screen.
- **Find the light switch** before you begin, not during.
- **Never ask who has been scammed.** Not for a show of hands, not anonymously,
  not as an icebreaker. The single most important thing in the room is that
...
>
> Before anything else: I'm not selling anything. I won't ask you for money, I
> won't ask for your information, and there's nothing to sign up for. I'm here
> for twenty-five minutes and then I'll take questions.

*[Pause. Let people settle.]*

> What I want to leave you with is three steps. That's it. Three.
...
>
> Her grandson was at work the whole time. He didn't know any of it had happened
> until she told him that night.

*[Pause. Let it land.]*

*[If you have a real local story, use that instead. Local always beats dramatic.
Never name anyone.]*
...
>
> That woman is not foolish. She raised four children and ran a business for
> thirty years.
>
> The people who called her do this full time. They work in call centres. They
> have scripts, and supervisors, and quotas. They practise. They test what works
> on thousands of people before they get to you.
>
> So nobody in this room is going to out-think a professional. I'm not going to
> ask you to.
...
> was thirty-eight thousand dollars.
>
> I don't tell you that to frighten you. I tell you because it means this is an
> **industry**. It's not a run of bad luck happening to careless people. It's a
> business, and you are its customer base.
...
> Here's what you say: *"I'm going to hang up and call the number on my card."*
>
...
>
> If he doesn't answer, call his mother. And let me say this clearly, because
> people hesitate here: that is not going behind anyone's back. If your grandson
> really is in a jail cell, his mother needs to know in the next ten minutes
> anyway.
>
> A real emergency survives one more phone call. A fake one can't.
...
>
> This is the one people skip, and it's the one that works even when the other
> two fail.
>
> Nothing legitimate in your life needs money to move in the next twenty minutes.
> Not the IRS. Not Medicare. Not your bank's fraud department. Not a warrant. Not
> a lawsuit. Not the electric company.
>
> Every one of those has an office, a process, and a paper trail. Every one of
> them will still be there tomorrow morning.

*[Slow down for this next sentence. It's the most useful idea in the talk.]*
...
*[Read it. Pause. Read it again.]*

> **The number they gave you is the scam.**
>
> Almost every one of these collapses the second you dial a number they didn't
> choose for you.
...
>
> There's software now that copies a person's voice from a few seconds of video.
> A Facebook post. A voicemail greeting. It's free and it takes about a minute.
>
> So "it sounded just like him" is not proof of anything any more. And you can't
> beat that by listening harder. I can't either.
>
...
>
> Four minutes at a Sunday dinner. And it defeats the entire thing.

*[Ask them to actually do it this week. Say that out loud.]*
...
> And there's a physical side to that. When you're frightened, your body dumps
> adrenaline, your hands go cold, and the careful part of your brain gets
> quieter. You are not imagining that you can't think straight. You genuinely
> can't, for a few minutes.
>
...
>
> Not the IRS. Not Microsoft. Not the electric company. Not a court. Not a bail
...
>
> Not to a safe account. Not to protect it. Not while they investigate. That
...
>
> You may not be able to tell whether a caller really works for your bank. But
> you can always tell **how they want the money**. And scammers only accept
> payments that can't be undone. That's the whole logic.
>
> Gift cards. Wire transfers. Bitcoin machines. Cash by courier. Payment apps to
> a stranger. And moving your money to a "safe account."
>
> So ask early: *"How do you want to be paid?"* It's a perfectly normal question,
> it doesn't accuse anybody, and quite often the answer ends the conversation for
> you.
...
>
> The shame is the last part of the scam. It's what keeps people quiet long
> enough for the money to disappear. So let's skip it.
>
...
>
> And tell one person. Not so they can fix it. So you're not carrying it alone.
...
*[Say both slowly. Twice. Point at the sheet in their hands.]*

> **Eight three three, three seven two, eight three one one.** That's the
> National Elder Fraud Hotline, run by the Department of Justice. Weekdays, ten
> to six Eastern.
>
...
>
> **No legitimate agency ever charges a fee to return your money.** Ever.
>
> I'm telling you now so that when it happens, it isn't a new emergency. It's
> just a call you were told about in a room one morning.
...
> So. Three steps.
>
> **Look up the number yourself.** **Call the person yourself.** **Wait a day.**

*[Fourth time they've heard them. That repetition is the whole method.]*
...
one." Telling you was the hard part. Don't make them regret it.

**If you don't know an answer, say so**, and give them 877-908-3360. "I don't
know, but here's who does" is a completely respectable answer and it protects you
from guessing wrong about somebody's money.

---

## Afterward

- Leave a stack of sheets at the front desk
- Ask the activities director whether they'd like copies for every unit
- Offer to come back in six months. Repetition is what makes the three steps
