...
<textarea id="message" name="message" rows="6" required maxlength="5000" style="width:100%;max-width:32rem;font:inherit;padding:.6rem"></textarea>
</p>

<p>
<label for="email">Your email, if you'd like a reply <em>(optional)</em></label><br>
<input type="email" id="email" name="email" maxlength="200" style="width:100%;max-width:32rem;font:inherit;padding:.5rem">
</p>
