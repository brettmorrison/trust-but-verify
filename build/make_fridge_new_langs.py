...
L["et"] = dict(brand="USALDA, AGA KONTROLLI",
  tagline="Võite jätkuvalt usaldada, lisage lihtsalt paus.",
...
L["lv"] = dict(brand="UZTICIES, BET PĀRBAUDI",
  tagline="Jūs varat turpināt uzticēties, vienkārši pievienojiet pauzi.",
  ...
  code_head="Mūsu ģimenes kodvārds:",
...
L["lt"] = dict(brand="PASITIKĖK, BET PATIKRINK",
  tagline="Galite toliau pasitikėti, tiesiog pridėkite pauzę.",
  ...
  code_head="Mūsų šeimos slaptažodis:",
...
L["ht"] = dict(brand="FÈ KONFYANS, MEN VERIFYE",
  tagline="Ou ka kontinye fè konfyans, jis ajoute yon ti pòz.",
...
L["pa"] = dict(brand="ਭਰੋਸਾ ਕਰੋ, ਪਰ ਪੁਸ਼ਟੀ ਕਰੋ",
  tagline="ਤੁਸੀਂ ਭਰੋਸਾ ਕਰਨਾ ਜਾਰੀ ਰੱਖ ਸਕਦੇ ਹੋ, ਬੱਸ ਇੱਕ ਵਿਰਾਮ ਜੋੜੋ।",
  ...
  code_head="ਸਾਡੇ ਪਰਿਵਾਰ ਦਾ ਕੋਡ ਸ਼ਬਦ:",
...
L["gu"] = dict(brand="વિશ્વાસ કરો, પણ ચકાસો",
  tagline="તમે વિશ્વાસ કરવાનું ચાલુ રાખી શકો છો, ફક્ત એક વિરામ ઉમેરો.",
  ...
  code_head="અમારા પરિવારનો કોડ શબ્દ:",
...
L["so"] = dict(brand="ISKA KALSOONOW, LAAKIIN XAQIIJI",
  tagline="Wali waad kalsoonaan kartaa, kaliya ku dar hal joogsi.",
  ...
  code_head="Erayga sirta ah ee qoyskeenna:",
...
L["km"] = dict(brand="ជឿទុកចិត្ត ប៉ុន្តែផ្ទៀងផ្ទាត់",
  tagline="អ្នកនៅតែអាចទុកចិត្តបាន គ្រាន់តែបន្ថែមការឈប់សម្រាកមួយ។",
  ...
  code_head="ពាក្យសម្ងាត់គ្រួសាររបស់យើង៖",
...
L["hmn"] = dict(brand="NTSEEG, TAB SIS XYUAS KOM POM TSEEB",
  tagline="Koj tseem tuaj yeem ntseeg, tsuas ntxiv ib qho so me ntsis.",
  ...
  code_head="Lo lus zais ntawm peb tsev neeg:",
...
L["ka"] = dict(brand="ენდე, მაგრამ გადაამოწმე",
  tagline="შეგიძლია განაგრძო ნდობა, უბრალოდ დაამატე პაუზა.",
  ...
  code_head="ჩვენი ოჯახის კოდური სიტყვა:",
...
L["it"] = dict(brand="FIDATI, MA VERIFICA",
  tagline="Puoi restare fiducioso, basta aggiungere una pausa.",
  ...
  code_head="La parola d'ordine della nostra famiglia:",
...
L["el"] = dict(brand="ΕΜΠΙΣΤΕΥΣΟΥ, ΑΛΛΑ ΕΠΑΛΗΘΕΥΣΕ",
  tagline="Μπορείτε να συνεχίσετε να εμπιστεύεστε, απλώς προσθέστε μια παύση.",
  ...
  code_head="Η κωδική λέξη της οικογένειάς μας:",
...
L["he"] = dict(brand="תבטח, אבל תוודא",
  tagline="אתה יכול להמשיך לבטוח, רק תוסיף הפסקה.",
  ...
  code_head="מילת הקוד של המשפחה שלנו:",
...
L["hu"] = dict(brand="BÍZZ, DE ELLENŐRIZZ",
  tagline="Továbbra is bízhat, csak adjon hozzá egy szünetet.",
  ...
  code_head="A családunk kódszava:",
...
L["hr"] = dict(brand="VJERUJ, ALI PROVJERI",
  tagline="Možete i dalje vjerovati, samo dodajte pauzu.",
  ...
  code_head="Lozinka naše obitelji:",
...
L["sr"] = dict(brand="ВЕРУЈ, АЛИ ПРОВЕРИ",
  tagline="Можете и даље да верујете, само додајте паузу.",
  ...
  code_head="Лозинка наше породице:",
...
L["ms"] = dict(brand="PERCAYA, TETAPI SAHKAN",
  tagline="Anda masih boleh percaya, cuma tambah satu jeda.",
  ...
  code_head="Kata kod keluarga kami:",
...
L["sv"] = dict(brand="LITA PÅ, MEN KONTROLLERA",
  tagline="Du kan fortsätta lita på andra, lägg bara till en paus.",
...
L["no"] = dict(brand="STOL PÅ, MEN KONTROLLER",
  tagline="Du kan fortsette å stole på andre, bare legg til en pause.",
...
L["da"] = dict(brand="STOL PÅ, MEN KONTROLLER",
  tagline="Du kan fortsætte med at stole på andre, tilføj bare en pause.",
  ...
  code_head="Vores families kodeord:",
...
L["sw"] = dict(brand="AMINI, LAKINI THIBITISHA",
  tagline="Unaweza kuendelea kuamini, ongeza tu pumziko.",
  ...
  code_head="Neno la siri la familia yetu:",
...
def draw(lang, d):
    ...
    c.setFont(FB, 9)
    c.setFillColor(INK)
    code_label = maybe_rtl(d["code_head"], lang)
    c.drawString(M, y, code_label)
    label_w = stringWidth(code_label, FB, 9)
    c.setStrokeColor(INK); c.setLineWidth(1)
    c.line(M + label_w + 8, y - 1, W - M, y - 1)
    y -= 16
