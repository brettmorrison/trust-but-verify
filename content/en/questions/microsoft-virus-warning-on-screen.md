---
title: Why does my computer say Microsoft detected a virus?
slug: /questions/microsoft-virus-warning-on-screen
description: It doesn't. That is a web page pretending to be one, and the phone number is the only dangerous thing on your screen.
lang: en
---

# Why does my computer say Microsoft detected a virus?

**It doesn't. That's a web page pretending to be a warning.**

**Microsoft never puts a phone number in an error message. Neither does Apple.
Neither does any real security program.** No operating system has ever asked you
to call anyone. That one fact settles it, permanently.

Your computer is fine. Nothing is infected. The phone number is the only
dangerous thing on that screen.
...
Done. Nothing else is needed. No scan, no cleanup, no call.
...
It's a photograph of an emergency, not an emergency.
...
and follow those steps in order.
...
Your computer is fine, your files are fine, and you didn't break anything. You
saw an advertisement designed to frighten you, and it didn't work.

Now you know the one fact that makes this permanently harmless: a real problem
never gives you a phone number.

---

**Related:** [The fake security popup](/scams/tech-support-popup)
